      ...
      <div className="relative shell">
        <div className="grid-12 gap-y-14">
          <div className="col-span-4 md:col-span-8 lg:col-span-7">
            ...
            <SplitLines id="repair-heading" lines={repair.heading} className="mt-8 text-h1" />
          </div>
        ...
        <div className="mt-[clamp(3.5rem,7vw,6rem)] grid-12 gap-y-12">
          <div className="col-span-4 md:col-span-8 lg:col-span-5">
            <Photo
              ...
              tone="deep"
            />
            <p className="mt-4 index text-muted-dark">Fig. 05</p>
          </div>
          <div className="col-span-4 md:col-span-8 lg:col-span-6 lg:col-start-7">
            <Reveal>
              <div className="flex items-baseline justify-between border-b border-paper/60 pb-4">
            ...
            <ItemList items={repair.issues} columns={2} tone="dark" />
          </div>
        </div>
