      ...
      <div className="shell">
        <div className="grid-12 gap-y-14">
          <div className="col-span-4 md:col-span-8 lg:col-span-6">
            ...
            <SplitLines id="water-heading" lines={waterSystems.heading} className="mt-8 text-h2" />
          </div>
        ...
        <div className="mt-[clamp(3.5rem,7vw,6rem)] grid-12 gap-y-14">
          <div className="col-span-4 md:col-span-8 lg:col-span-4">
            <div className="lg:sticky lg:top-[calc(var(--header-h)+2rem)]">
              <Photo
                ...
                parallax={6}
              />
              <p className="mt-4 index text-muted">Fig. 04</p>
            </div>
          </div>

          <div className="col-span-4 grid gap-14 md:col-span-8 md:grid-cols-2 md:gap-[calc(var(--gutter)*2)] lg:col-span-7 lg:col-start-6">
            {waterSystems.columns.map((col, i) => (
              <div key={col.title}>
                ...
                <ItemList items={col.items} columns={1} />
              </div>
            ))}
          </div>
        </div>
